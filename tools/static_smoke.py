...
check('current release metadata is active', ('"1.1.8"' in plugin or '"1.1.9"' in plugin or '"1.2.0"' in plugin or '"1.2.1"' in plugin or '"1.2.2"' in plugin) and ('1.1.8.0' in text('HealthAutoArrange.Plugin/Properties/AssemblyInfo.cs') or '1.1.9.0' in text('HealthAutoArrange.Plugin/Properties/AssemblyInfo.cs') or '1.2.0.0' in text('HealthAutoArrange.Plugin/Properties/AssemblyInfo.cs') or '1.2.1.0' in text('HealthAutoArrange.Plugin/Properties/AssemblyInfo.cs') or '1.2.2.0' in text('HealthAutoArrange.Plugin/Properties/AssemblyInfo.cs')))
